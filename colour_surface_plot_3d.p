...
#rgb(r,g,b) = 10000 * int(r * 100) + 100 * int(g * 100) + int(b * 100);


rgb(r,g,b) = 65536 * int(r * 256) + 256 * int(g * 256) + int(b * 256);

#rgb(r,g,b) = '#'.sprintf( "%12.0f", 65536 * int(r * 256) + 256 * int(g * 256) + int(b * 256));
...
splot data_folder using (column(5)):(column(6)):1:(rgb($2, $3, $4)) with lines lc rgb variable; 
